...
def draw_circles1():
    ...
    print('--------------------------------------------------')
    radius=0
    centerpoint = rg.Point(200.0, 200.0)
...
def draw_circles2():
    ...
    for k in range (18):
        centerpoint=rg.Point(50+k*20,100)
        circle=rg.Circle(centerpoint,10)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
def print_sequence3():
...
def draw_circles3():
    ...
    for k in range(100):
        circle=rg.Circle(centerpoint,k+1)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    window=rg.RoseWindow(400,400)
    for k in range(101):
        centerpoint=rg.Point(200+(80*math.cos(k)),200+(80*math.sin(k)))
        circle=rg.Circle(centerpoint,10)
        circle.attach_to(window)
    window.render()
    window.close_on_mouse_click()
